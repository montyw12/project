...
{
    $queryString = "SELECT user_id, type, name, address, email, item_has, status FROM user LEFT JOIN provider_client ON user_id = f_provider_id WHERE type = 'producer' AND f_client_id = ? AND status = 3 ORDER BY name;";
