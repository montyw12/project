...
{
    $queryString = "SELECT user_id, name, address, email, status FROM users LEFT JOIN provider_client ON user_id = f_provider_id WHERE (type = 'producer'  AND (f_client_id = ? OR f_client_id IS NULL));";
