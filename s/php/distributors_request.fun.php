...
{
    $quearyString = "SELECT user_id, type, name, address, email, status FROM users LEFT JOIN provider_client ON user_id = f_provider_id WHERE type = 'distributor' AND f_client_id = ? AND status = 1 ORDER BY name";
