...
{
    $queryString = "SELECT user_id, name, address, email, status FROM users LEFT JOIN provider_client ON user_id = f_provider_id WHERE type = 'distributor' AND f_client_id = ? AND status = 3 ORDER BY name;";
