...
function selectSpecificExpireItem($beforExpireDay, $sellerId)
{
    ...
    $expireDay = date("Y-m-d", (time() + (86400 * $beforExpireDay)));
    ...
    unset($queryString, $dbConn, $stmt, $expireDay, $beforExpireDay, $sellerId);
    return $resultToReturn;
}


// #2 function
function errorsForSelectSpecificItem($error_code)
{
    switch ($error_code) {
        case 0:
