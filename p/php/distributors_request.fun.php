...
{
    $quearyString = "SELECT user_id, type, name, address, email, item_has, status FROM user LEFT JOIN provider_client ON user_id = f_client_id WHERE type = 'distributor' AND f_provider_id = ? AND status = 2 ORDER BY name";
