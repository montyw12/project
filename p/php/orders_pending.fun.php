...
{
    $queryString = "SELECT t1.order_id, t1.order_date, t1.dispatch_date, t1.delivery_date, t1.item_no, t2.f_provider_id, t3.user_id AS client_id, t3.name AS client_name, t3.email AS client_email, t3.address AS client_address FROM orders AS t1 JOIN provider_client AS t2 ON t1.f_provider_client_id = t2.r_id JOIN users AS t3 ON t2.f_client_id = t3.user_id WHERE t1.status = 1 AND t2.status = 3 AND t2.f_provider_id = ? ORDER BY t2.f_provider_id ASC, t1.order_date DESC;";
